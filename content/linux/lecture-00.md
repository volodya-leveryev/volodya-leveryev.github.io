...
![Стекируемый оконный меннеджер]({static}/images/linux-image2.png "Стекируемый оконный меннеджер")
...
![Тайловый оконный меннеджер]({static}/images/linux-image1.png "Тайловый оконный меннеджер")
