...
<tbody>
  <tr><td>`==`</td><td>Равно</td><td>Проверяет равенство значений</td></tr>
  <tr><td>`!=`</td><td>Не равно</td><td>Проверяет неравенство значений</td></tr>
  <tr><td>`>`</td><td>Больше</td><td>Проверяет, больше ли левый операнд</td></tr>
  <tr><td>`<`</td><td>Меньше</td><td>Проверяет, меньше ли левый операнд</td></tr>
  <tr><td>`>=`</td><td>Больше или равно</td><td>Проверяет, больше или равен левый операнд</td></tr>
  <tr><td>`<=`</td><td>Меньше или равно</td><td>Проверяет, меньше или равен левый операнд</td></tr>
</tbody>
</table>
