...
<thead>
<tr>
<th>Оператор</th><th>Название</th><th>Описание</th>
</tr>
</thead>
<tbody>
<tr>
<tr><td>`+`<td></td> Сложение              <td></td> Складывает два операнда                        </tr></tr>
<tr><td>`-`<td></td> Вычитание             <td></td> Вычитает правый операнд из левого              </tr></tr>
<tr><td>`*`<td></td> Умножение             <td></td> Умножает два операнда                          </tr></tr>
<tr><td>`/`<td></td> Деление               <td></td> Вещественное деление (в ответе не целые числа) </tr></tr>
<tr><td>`//`<td></td> Целочисленное деление <td></td> Целое деление (в ответе целые числа)           </tr></tr>
<tr><td>`%`<td></td> Остаток от деления    <td></td> Возвращает остаток от деления                  </tr></tr>
<tr><td>`**`<td></td> Возведение в степень  <td></td> Возводит левый операнд в степень правого       </tr></tr>
</tr>
</tbody>
</table>
