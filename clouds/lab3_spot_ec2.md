...
1. Откройте AWS Pricing Calculator: [calculator.aws](https://calculator.aws/) и создайте новый расчёт (Create estimate).
2. С помощью фильтра `Find Service` найдите сервис EC2.
3. Рассчитайте стоимость месячной аренды EC2-инстанса **t3.small** в следующих режимах (в произвольно выбранном регионе):
...
4. Сравните разницу в стоимости между этими вариантами.
5. Добавьте скриншот в отчет.
